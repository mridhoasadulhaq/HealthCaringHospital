...
### Project Objectives
I analyzed this data as a data analyst working for fictional hospital called Health Caring Hospital using MS SQL Server. The focus of the analyst was on discharge, to explore how discharges affects hospital length of stay, discharge distribution for different age group, gender and by the day of week and how does discharge looks like everyday.


### SQL Concept Used
GROUP BY
Agreggate function (SUM(), COUNT())
